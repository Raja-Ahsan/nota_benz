                ...
                <div class="auth-card">
                    ...
                    <div class="auth-card__eyebrow">
                        ...
                        <p class="auth-card__eyebrow-text">
                            <span class="auth-card__eyebrow-scene manrope-font">SCENE <span class="text-primary mx-1.5">I</span></span>
                            <span class="auth-card__eyebrow-sub cormorant-font">— Identity / Access</span>
                        </p>
                    </div>
