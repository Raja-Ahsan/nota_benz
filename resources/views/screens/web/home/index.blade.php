            ...
            <div class="pointer-events-none absolute inset-0 z-0" aria-hidden="true">
                <div class="absolute inset-0 overflow-hidden">
                    <div
                        ...
                        style="background-image: url('{{ asset('assets/images/slider-img-01.png') }}'); will-change: opacity; opacity: 1;"
                    ></div>
                    <div
                        data-story-img
                        data-index="1"
                        ...
                        class="absolute inset-0 bg-cover bg-center bg-no-repeat transition-[opacity,transform] duration-700 ease-out motion-reduce:transition-none"
                        style="background-image: url('{{ asset('assets/images/slider-img-02.png') }}'); will-change: opacity; opacity: 0;"
                    ></div>
                    <div
                        data-story-img
                        data-index="2"
                        ...
                        class="absolute inset-0 bg-cover bg-center bg-no-repeat transition-[opacity,transform] duration-700 ease-out motion-reduce:transition-none"
                        style="background-image: url('{{ asset('assets/images/slider-img-03.png') }}'); will-change: opacity; opacity: 0;"
                    ></div>
                    <div
                        data-story-img
                        data-index="3"
                        ...
                        class="absolute inset-0 bg-cover bg-center bg-no-repeat transition-[opacity,transform] duration-700 ease-out motion-reduce:transition-none"
                        style="background-image: url('{{ asset('assets/images/slider-img-04.png') }}'); will-change: opacity; opacity: 0;"
                    ></div>
                </div>
            </div>
