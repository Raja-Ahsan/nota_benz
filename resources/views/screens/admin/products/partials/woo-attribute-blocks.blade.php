...
<div class="woo-attr-blocks">
    <div class="d-flex flex-wrap align-items-start justify-content-between gap-2 mb-3">
        <div>
            ...
            <p class="text-muted small mb-0">{{ __('One color per card. Enter the color once, then add sizes — each size can have its own price and variant image.') }}</p>
        </div>
                        ...
                        <table class="table table-borderless align-middle mb-0">
                            <thead>
                                <tr class="c-o-light f-w-600 small">
                                    <th style="width: 20%">{{ __('Size') }} <span class="text-danger">*</span></th>
                                    <th style="width: 20%">{{ __('Price') }} <span class="text-danger">*</span></th>
...
<template id="woo-tpl-row">
    <tr class="js-woo-row">
        <td>
            <input type="text" class="form-control js-woo-size" placeholder="{{ __('e.g. M') }}" required />
        </td>
        <td>
            <input type="number" class="form-control js-woo-price" step="0.01" min="0" placeholder="0.00" required />
        </td>
        <td>
...
<template id="woo-tpl-block">
    <div class="card js-woo-attr-block shadow-none border" data-woo-block>
        ...
        <div class="card-body pt-3">
            <div class="mb-3">
                <label class="form-label">{{ __('Color') }} <span class="text-danger">*</span></label>
                <input type="text" class="form-control js-woo-color" placeholder="{{ __('e.g. Black') }}" required />
            </div>
            <label class="form-label small text-muted mb-2 d-block">{{ __('Sizes') }}</label>
            <div class="table-responsive">
                <table class="table table-borderless align-middle mb-0">
