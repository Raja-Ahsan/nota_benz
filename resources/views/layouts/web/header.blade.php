<header class="absolute inset-x-0 top-0 z-50 ">
    <div class="container  flex  items-center justify-between gap-4 py-4 px-4 sm:px-6  lg:px-8">
        ...
        <div class="flex flex-1 items-center justify-end gap-6 lg:gap-12 xl:gap-20">
            ...
            <nav class="hidden items-center gap-6 lg:flex xl:gap-10 manrope-font" aria-label="{{ __('Primary') }}">
                ...
                <a href="{{ route('blog.index') }}" class="desktop-nav-link">Blogs</a>
            </nav>
    ...
    <div
        ...
        <nav class="main-container px-4 py-4 sm:px-6 lg:px-8 manrope-font">
            ...
            <a
                href="{{ route('login') }}"
                class="mt-3 flex w-full items-center justify-center border border-[var(--primary-color)] px-5 py-3 text-sm font-semibold uppercase tracking-wider text-[var(--primary-color)] transition-colors hover:bg-[color-mix(in_srgb,var(--primary-color)_12%,transparent)] manrope-font">{{ __('Login') }}</a>
            <a
                href="{{ route('register') }}"
                class="mt-3 flex w-full items-center justify-center border border-[var(--primary-color)] px-5 py-3 text-sm font-semibold uppercase tracking-wider text-[var(--primary-color)] transition-colors hover:bg-[color-mix(in_srgb,var(--primary-color)_12%,transparent)] manrope-font">{{ __('Sign Up') }}</a>
            @endguest
