<footer class="bg-white">
    <div class="container  py-12  sm:py-14 lg:py-16">
        <div class="grid grid-cols-1 gap-10 sm:grid-cols-2 sm:gap-12 lg:grid-cols-4 lg:gap-8 xl:gap-10">
            ...
            <div class="sm:col-span-2 lg:col-span-1">
                ...
                <p class="max-w-[250px] leading-[1.5] italic text-[var(--text-color)] text-[16px]">
            ...
            <div class="sm:col-span-2 lg:col-span-1">
                ...
                <ul class="footer-ul">
                    ...
                    <li><a href="#" class="footer-link">Amazon Store</a></li>
                    <li><a href="{{ url('/') }}" class="footer-link">Official site</a></li>
                </ul>
                <h2 class="mt-4 footer-title">
                    Location
                </h2>
                <p class="mt-2 text-[13px] leading-[1.5] text-[var(--text-color)] font-normal">
    ...
    <div class="">
    <div class="max-w-5xl mx-auto h-[1px] bg-[var(--text-color)]/10"></div>
        <div class="container mx-auto max-w-7xl flex flex-col gap-4 px-4 py-6 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
            <p class="text-center text-[11px] text-[var(--text-color)] sm:text-left font-normal">
